...
<?php $__env->startSection('title', 'Educational ERP System'); ?>
...
<div class="container d-flex flex-column align-items-center justify-content-center min-vh-100">
    <div class="glass-card w-100" style="max-width: 650px;">
        ...
        <div class="text-center">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg px-5 me-2">Login</a>
            <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-lg px-5">Student Register</a>
        </div>
    </div>
</div>
<footer class="footer mt-5">
    <div class="container text-center">
        ...
        <div class="small">&copy; <?php echo e(date('Y')); ?> Educational ERP. All rights reserved.</div>
    </div>
</footer>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-education-erp\resources\views/home.blade.php ENDPATH**/ ?>